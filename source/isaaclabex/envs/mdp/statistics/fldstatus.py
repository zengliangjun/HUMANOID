...
class FLDCollect(ManagerTermBase):
    ...
    def __init__(self, cfg: StatisticsTermCfg, env: ManagerBasedRLEnv):
        ...
        self.reset_flats = torch.ones((self.num_envs, ), \
                                           device = self.device, \
                                           dtype = torch.bool)
    ...
    def __call__(self):
        ...
        self.history_status[self.reset_flats, ...] = status_list[self.reset_flats, None, :]
        self.reset_flats[...] = False
