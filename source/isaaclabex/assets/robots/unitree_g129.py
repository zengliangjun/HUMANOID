...
UNITREE_GO129_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{_ASSETS_ROOT}/robots/usd/g129dof/g1_29dof.usd",
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        ...
        joint_pos={
            # lower body (12 dof)
            "left_hip_pitch_joint": 0.0, # -0.1,
            "left_hip_roll_joint": 0.0,
            "left_hip_yaw_joint": 0.0,
            "left_knee_joint": 0.0, # 0.3,
            "left_ankle_pitch_joint": 0.0, # -0.2,
            "left_ankle_roll_joint": 0,
            "right_hip_pitch_joint": 0.0, # -0.1,
            "right_hip_roll_joint": 0.0,
            "right_hip_yaw_joint": 0.0,
            "right_knee_joint": 0.0, # 0.3,
            "right_ankle_pitch_joint": 0.0, # -0.2,
