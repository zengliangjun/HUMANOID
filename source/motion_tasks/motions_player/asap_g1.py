...
from isaaclabmotion.assets.motions import asap_asapg1
...
class MotionsCfg:
    ...
    asapg1 = asap_asapg1.ASAPG129DOF23_CFG


@configclass
class ASAPEnvCfg(env_motions_cfg.ManagerMotionsCfg):
    ...
    def __post_init__(self):
        ...
        self.motions.asapg1.step_dt = self.decimation * self.sim.dt
        self.motions.asapg1.random_sample = False
