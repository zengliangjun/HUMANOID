...
from motion_tasks.motions_player import hover_h1
...
def main():
    ...
    env_cfg = hover_h1.HOVERH1EnvCfg()
    env_cfg.scene.robot = unitree_hoverh1.H1HOVER_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
