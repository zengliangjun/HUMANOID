...
class RewardsCfg:
    ...
    rew_step_mean_mean = RewardTermCfg(
        func=reward_collect.rew_step_mean_mean,
        weight=0.2,
        params={"asset_cfg": SceneEntityCfg("robot"),
                "pos_statistics_name": "pos",
                "jhipp_name": "left_hip_pitch_joint",
                "jknee_name": "left_knee_joint",
                "jother_names": [
                                #"left_ankle_pitch_joint",
    ...
    rew_step_variance_mean = RewardTermCfg(
        func=reward_collect.rew_step_variance_mean,
        weight=0.2,
        params={"asset_cfg": SceneEntityCfg("robot"),
                "pos_statistics_name": "pos",
                "jhipp_name": "left_hip_pitch_joint",
    ...
    rew_episode_mean = RewardTermCfg(
        func=reward_collect.rew_episode_mean,
        weight=0.2,
        params={"asset_cfg": SceneEntityCfg("robot"),
                "pos_statistics_name": "pos",
                "jhipp_names": ["left_hip_pitch_joint","right_hip_pitch_joint"],
                "jknee_names": ["left_knee_joint","right_knee_joint"],
                "jother_names": [
                                #"left_ankle_pitch_joint",
    ...
    rew_episode_mean_symmetry = RewardTermCfg(
        func=reward_collect.rew_episode_mean_symmetry,
        weight=0.2,
        params={"asset_cfg": SceneEntityCfg("robot"),
                "pos_statistics_name": "pos",
                "jhipp_names": ["left_hip_pitch_joint","right_hip_pitch_joint"],
    ...
    rew_episode_variance = RewardTermCfg(
        func=reward_collect.rew_episode_variance,
        weight=0.2,
        params={"asset_cfg": SceneEntityCfg("robot"),
                "pos_statistics_name": "pos",
                "jhipp_names": ["left_hip_pitch_joint","right_hip_pitch_joint"],
    ...
    rew_episode_variance_symmetry = RewardTermCfg(
        func=reward_collect.rew_episode_variance_symmetry,
        weight=0.2,
        params={"asset_cfg":
                SceneEntityCfg("robot",
                    joint_names=[
