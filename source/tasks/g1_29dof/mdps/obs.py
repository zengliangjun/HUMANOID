...
class ObservationsCfg:
    ...
    class CriticCfg(ObservationGroupCfg):
        ...
        joint_acc = ObservationTermCfg(func=privileged.joint_acc, scale = 0.05,
                                       params={"asset_cfg": SceneEntityCfg("robot")})
        joint_torques = ObservationTermCfg(func=privileged.joint_torques, scale = 0.05,
                                       params={"asset_cfg": SceneEntityCfg("robot")})
        body_mass = ObservationTermCfg(func=privileged.body_mass, scale = 0.6,
                                       params={"asset_cfg": SceneEntityCfg("robot")})
        feet_contact_forces = ObservationTermCfg(func=privileged.feet_contact_forces, scale = 0.02,
