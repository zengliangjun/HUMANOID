...
from isaaclab.utils import configclass
from .mdps  import mdps, curriculum, rewards
from isaaclabex.terrains.config import rough_low_level_cfg

from tasks.g1_15dofv0.mdps import obs, events, mdps as mdps15
...
class G1ObsStatisticsCfg(rl_env_exts_cfg.ManagerBasedRLExtendsCfg):
    ...
    actions =  mdps15.ActionsCfg()
    commands = mdps15.CommandsCfg()
    # MDP settings
    statistics = mdps.StatisticsCfg()
    rewards = rewards.RewardsG21Cfg()
    terminations = mdps15.TerminationsCfg()
